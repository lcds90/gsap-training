export default {
  ...
  pt: {
    ...
    examples: "Exemplos",
    install: {
      p1: "A instalação possui dois métodos",
      visit: "Visite esse",
      visit_about:
        "para um guia de ajuda, útil caso já queira acompanhar a instalação com os plugins e como registrar-los a depender do ambiente.",
    },
    api_basics: {
      title: "Básico da API",
      description:
